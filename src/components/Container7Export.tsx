...
import Calender2 from "../assets/images/notify.png";
import Guy from "../assets/images/guy.png";



const Container7Export = () => {
  return (
 <>
      <Container4>
      <Part2 >
        ...
        Never miss an important deadline or event again
          ...
          <div style={{display: "flex", marginLeft: "25%", marginRight: "-170px", position: "relative", right: "0px"}}>
           <div style={{background: "#2E2E2E", margin: "-10px 0px", width: "70%", borderRadius: "15px 15px 5px 15px", height:"110px"}}>
            <p style={{color:"#FEFEFE", padding: "0px 15px" }}>I've recommended this app to all my friends and colleagues! </p>
            <p style={{color:"#90909E", padding: "0px 15px" }}>Karl, CTO of a cool startup </p>
           </div>
           <div style={{width:"50%", marginTop: "50px" , marginRight: "0px" }}>
           <img src={Guy} width={"40%"}/>
           </div>
          </div>
        </Part1>
...
export default Container7Export
